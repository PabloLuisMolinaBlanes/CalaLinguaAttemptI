...
function Gallery() {
    return (
        ...
        <div id="gallery" className="flex flex-col pb-32 font-inter text-xl">
            <div id="top" className="flex max-lg:flex-col lg:flex-row pb-16">
                <div id="left" className=" flex flex-col pl-4 max-lg:w-100/100 lg:w-33/100">
                    <div id="image" className="border-1 h-100 w-100"></div>
                ...
                <div id="right" className=" flex flex-col pr-4 max-lg:w-100/100 lg:w-33/100">
                    <div id="image" className="border-1 h-100 w-100"></div>
                    <div id="text" className="pt-4">
            ...
            <div id="bottom" className="flex max-lg:flex-col lg:flex-row ">
                <div id="left" className=" flex flex-col pl-4 max-lg:w-100/100 lg:w-33/100">
                    <div id="image" className="border-1 h-100 w-100"></div>
                    <div id="text" className="pt-4">
